...
This project systematically analyzes and documents all artists directly followed by Spotify user `w5j8x1tlo0desiwgo7f0ulpc1`. The goal is the complete evidence-based collection of artist data to identify network patterns, manipulation indicators, and thematic clusters within the German Rap/Trap scene.
...
- **Bot Scale**: Classification of manipulation levels
- **Network Mapping**: Visualization of artist relationships
...
- **Browser Automation**: MCP Browser Tools for Spotify navigation
- **Data Extraction**: Systematic web scraping methodology
- **Documentation**: Markdown-based profiles
- **Archiving**: Archive.is for traceability

## License

This project serves research and analysis of music networks. All data is taken from publicly available information and documented.
